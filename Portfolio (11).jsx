...
// ── Place your certificate PDF in your project's public folder as /patent-certificate.pdf
// ── OR replace the certificateUrl below with your Google Drive preview link:
...
const patents = [
  {
    ...
    accent: "#0EA5E9",
    flag: "🇬🇧",
    // ↓ Put your Google Drive preview link here, or "/patent-certificate.pdf" if hosted locally
    certificateUrl: "/patent-certificate.pdf",
  },
];
...
// ═══════════════════════════════════════════════════════════════
// PATENT MODAL — always shows the certificate PDF (no upload needed)
// ═══════════════════════════════════════════════════════════════
...
export default function Portfolio() {
  ...
  // (no upload state needed — PDF is hardcoded in patent data)
